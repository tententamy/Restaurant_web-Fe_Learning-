    ...
    <div className="bg-[#040404] min-h-screen">
      ...
      {/* <nav className="flex items-center justify-between fixed top-0 left-0 w-full bg-[#040404] px-8 py-4 text-[#969493] z-50">
            ...
            <div className="flex gap-10 mr-10">
                ...
                <Link href="/bar/drinks">DRINKS</Link>
                <Link href="/bar/small-hunger">SMALL HUNGER</Link>
                <Link href="/bar/suggestions">SUGGESTIONS</Link>
                <Link href="/bar/photos">PHOTOS</Link>
                <Link href="/bar/about">ABOUT US</Link>
                <Link href="/bar/contact">CONTACT US</Link>
            </div>
        </nav> */}
      <Header/>
